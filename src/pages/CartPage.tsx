  ...
  return (
    <div className="container my-4">
      ...
      <div id="randomProductsCarousel" className="carousel slide" data-bs-ride="carousel">
        ...
        <button className="carousel-control-prev" type="button" data-bs-target="#randomProductsCarousel" data-bs-slide="prev">
          <span className="carousel-control-prev-icon" aria-hidden="true"></span>
          <span className="visually-hidden">Previous</span>
        </button>
        <button className="carousel-control-next" type="button" data-bs-target="#randomProductsCarousel" data-bs-slide="next">
